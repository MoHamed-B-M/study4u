...
class _StatsViewState extends ConsumerState<StatsView>
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FadeTransition(
                          opacity: _fadeController.drive(
                            CurveTween(curve: const Interval(0.2, 0.6, curve: Curves.easeOut)),
                          ),
                        ...
                        FadeTransition(
                          opacity: _fadeController.drive(
                            CurveTween(curve: const Interval(0.4, 0.8, curve: Curves.easeOut)),
                          ),
                          child: PomodoroCard(
  ...
  Widget _buildSubjectPerformance(BuildContext context, List<CourseEntity> courses) {
    if (courses.isEmpty) {
      return DashboardCard(
        backgroundColor: DesignTokens.surface,
        borderRadius: DesignTokens.radiusLG,
